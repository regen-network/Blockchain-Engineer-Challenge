...
func (m *PostComment) GetAuthor() string {
	if m != nil {
		return m.Author
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*PostComment)(nil), "blog.v1.PostComment")
}
...
var fileDescriptor_73573037ee301d2b = []byte{
	...
	0xca, 0x4f, 0xa9, 0x94, 0x60, 0x81, 0x98, 0x00, 0x62, 0x2b, 0xf9, 0x72, 0x71, 0x83, 0x4c, 0x77,
	0xce, 0xcf, 0xcd, 0x4d, 0xcd, 0x23, 0xcd, 0x12, 0x98, 0x71, 0xcc, 0x08, 0xe3, 0x9c, 0x6c, 0x4f,
	0x3c, 0x92, 0x63, 0xbc, 0xf0, 0x48, 0x8e, 0xf1, 0xc1, 0x23, 0x39, 0xc6, 0x09, 0x8f, 0xe5, 0x18,
	0x2e, 0x3c, 0x96, 0x63, 0xb8, 0xf1, 0x58, 0x8e, 0x21, 0x4a, 0x39, 0x3d, 0xb3, 0x24, 0xa3, 0x34,
	0x49, 0x2f, 0x39, 0x3f, 0x57, 0xbf, 0x28, 0x35, 0x3d, 0x35, 0x4f, 0x37, 0x2f, 0xb5, 0xa4, 0x3c,
	0xbf, 0x28, 0x5b, 0x3f, 0x29, 0x35, 0x59, 0xbf, 0x42, 0x1f, 0xe4, 0xdd, 0x24, 0x36, 0xb0, 0xdf,
	0x8d, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x70, 0x7b, 0xa7, 0x66, 0x12, 0x01, 0x00, 0x00,
}
...
func (m *PostComment) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PostComment) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PostComment) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *PostComment) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PostComment: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PostComment: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
